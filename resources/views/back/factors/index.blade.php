            ...
            <div class="col-lg-12">
                <div class="panel panel-default">
                    <div class="panel-heading">
                        因素列表
                        <a href="{{ route('factors.create') }}" class="btn btn-primary">添加</a>
                    </div>
                    <!-- /.panel-heading -->
                        ...
                        <div class="table-responsive">
                            <table class="table table-striped table-bordered table-hover">
                                ...
                                @if (session('factor-ok'))
                                    ...
                                    @endcomponent
                                @endif
                                @include('back.factors.table', compact('factors'))
                                </tbody>
                            </table>
                        </div>
                        <!-- /.table-responsive -->
...
@section('js')
    ...
    <script>
        ...
        var factor = (function () {
            ...
            var url = '{{ route('factors.index') }}'
            var swalTitle = '@lang('Really destroy factor ?')'
